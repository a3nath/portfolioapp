...
class TestViews(TestCase):
    ...
    def setUp(self):
        ...
        self.update_url = reverse('update-holding', args=['ticker'])
        # self.asset = Asset.objects.create('ticker' = 'testTicker')
    ...
    def test_home_search_ticker_POST(self):
        ...
        #search
        response = self.client.post(self.home_url, {'searchticker': 'Search'}, follow=True)
